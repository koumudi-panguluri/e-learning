...
import { BellIcon, MenuIcon, XIcon, ArrowSmDownIcon, ArrowSmUpIcon, UsersIcon, MailOpenIcon, CursorClickIcon } from '@heroicons/react/outline'
              ...
              <div className="lg:grid lg:grid-cols-2 lg:gap-24 lg:items-center">
                <div className="max-w-7xl mx-auto pb-12 px-4 sm:px-6 lg:px-8">
                  <div className={`${styles.profile_container} rounded-2xl`}>
                    <div className="p-4 flex items-center justify-center h-30 w-30 rounded-full">
                      <img
                    ...
                    <div className='flex flex-col justify-center pb-4'>
                      <div className="text-3xl font-normal self-center">John Doe</div>
                ...
                <div className="mt-12 lg:grid lg:grid-cols-2 lg:gap-2 lg:items-center">

                  <div className={`rounded-lg ${styles.info_card} w-full h-96 flex flex-row lg:flex flex-col`}>


                    <img src="/transp_profile.gif" width={250} />
                  </div>
                  {/* <iframe src="https://embed.lottiefiles.com/animation/72322" width={200} height={200}></iframe> */}
